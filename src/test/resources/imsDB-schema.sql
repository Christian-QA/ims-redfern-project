...
insert into imsDB.customers(forename, surname) values ('Harry', 'Handles');
insert into imsDB.products(name, category, inventory,price) values ('Ham Sandwich', 'Food', 3000, 2.49);
insert into imsDB.orders(customer_id, date_ordered) values('1', '2019-11-11');