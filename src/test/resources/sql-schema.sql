...
create table if not exists imsDB.products(product_id int primary key NOT NULL auto_increment, name varchar(200) NOT NULL, category varchar(20) DEFAULT 'Miscellaneous', price double(10,2) DEFAULT 0, inventory int(11) DEFAULT 0);
